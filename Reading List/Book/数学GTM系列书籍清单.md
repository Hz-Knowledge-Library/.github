...
- [x] **GTM 7** - A Course in Arithmetic - *Jean-Pierre Serre* ⭐
...
- [ ] **GTM 65** - Differential Analysis on Complex Manifolds - *Raymond O. Wells, Jr.* (3rd ed.)
- [ ] **GTM 198** - An Introduction to Riemann-Finsler Geometry - *David Bao, Shiing-Shen Chern, Zhongmin Shen*

### 4.4 凸几何

- [ ] **GTM 90** - An Introduction to Convex Polytopes - *Arne Brondsted*
- [ ] **GTM 152** - Lectures on Polytopes - *Günter M. Ziegler*
- [ ] **GTM 221** - Convex Polytopes - *Branko Grünbaum* (2nd ed.)
- [ ] **GTM 286** - Lectures on Convex Geometry - *Daniel Hug, Wolfgang Weil*
...
- [ ] **GTM 172** - Classical Topics in Complex Function Theory - *Reinhold Remmert*
- [ ] **GTM 199** - From Holomorphic Functions to Complex Manifolds - *Klaus Fritzsche, Hans Grauert*
...
- [ ] **GTM 182** - Ordinary Differential Equations - *Wolfgang Walter*

### 8.2 偏微分方程

- [ ] **GTM 128** - Partial Differential Equations - *Jeffrey Rauch*
- [ ] **GTM 200** - Partial Differential Equations - *Jürgen Jost* (3rd ed.)
- [ ] **GTM 293** - Partial Differential Equations - *Wolfgang Arendt, Karsten Urban*
...
## 9. 逻辑与集合论 (Logic and Set Theory)

### 9.1 集合论

- [ ] **GTM 1** - Introduction to Axiomatic Set Theory - *Gaisi Takeuti, Wilson M. Zaring* (2nd ed.)
- [ ] **GTM 8** - Axiomatic Set Theory - *Gaisi Takeuti, Wilson M. Zaring*
...
- [ ] **GTM 156** - Classical Descriptive Set Theory - *Alexander S. Kechris* ⭐
- [ ] **GTM 180** - A Course on Borel Sets - *S. M. Srivastava*

### 9.4 可计算性理论

- [ ] **GTM 146** - Computability: A Mathematical Sketchbook - *Douglas S. Bridges*

---

## 10. 组合数学 (Combinatorics)
...
- [ ] **GTM 203** - The Symmetric Group - *Bruce E. Sagan* (2nd ed.)
- [ ] **GTM 212** - Lectures on Discrete Geometry - *Jiří Matoušek*
- [ ] **GTM 226** - Combinatorics of Coxeter Groups - *Anders Björner, Francisco Brenti*
- [ ] **GTM 254** - A Course in Enumeration - *Martin Aigner*
- [ ] **GTM 289** - Lessons in Enumerative Combinatorics - *Omer Egecioglu, Adriano Garsia*

### 10.3 编码理论

- [ ] **GTM 86** - Introduction to Coding Theory - *J. H. van Lint* (3rd ed.)
- [ ] **GTM 134** - Coding and Information Theory - *Steven Roman*
- [ ] **GTM 254** - Algebraic Function Fields and Codes - *Henning Stichtenoth* (2nd ed.)

---

## 11. 环与模 (Rings and Modules)

- [ ] **GTM 13** - Rings and Categories of Modules - *Frank W. Anderson, Kent R. Fuller* (2nd ed.)
- [ ] **GTM 88** - Associative Algebras - *R. S. Pierce*
- [ ] **GTM 189** - Lectures on Modules and Rings - *Tsit-Yuen Lam*

---

## 12. 代数拓扑专题 (Special Topics in Algebraic Topology)

- [ ] **GTM 20** - Fibre Bundles - *Dale Husemoller* (3rd ed.) 🔥
- [ ] **GTM 147** - Algebraic K-Theory and Its Applications - *Jonathan Rosenberg*
- [ ] **GTM 169** - Sheaf Theory - *Glen E. Bredon* (2nd ed.)

---

## 13. 李群与表示论 (Lie Groups and Representation Theory)

- [ ] **GTM 98** - Representations of Compact Lie Groups - *Theodor Bröcker, Tammo tom Dieck* ⭐
- [ ] **GTM 129** - Representation Theory - *William Fulton, Joe Harris* ⭐
- [ ] **GTM 225** - Compact Lie Groups - *M. R. Sepanski*
- [ ] **GTM 255** - Symmetry, Representations, and Invariants - *Roe Goodman, Nolan R. Wallach*

---

## 14. 黎曼曲面与复流形 (Riemann Surfaces and Complex Manifolds)

- [ ] **GTM 71** - Riemann Surfaces - *Herschel Farkas, Irwin Kra* (2nd ed.)
- [ ] **GTM 81** - Lectures on Riemann Surfaces - *Otto Forster*
- [ ] **GTM 109** - Univalent Functions and Teichmüller Spaces - *O. Lehto*
- [ ] **GTM 183** - Moduli of Curves - *Joe Harris, Ian Morrison*

---

## 15. 动力系统 (Dynamical Systems)

- [ ] **GTM 132** - Iteration of Rational Functions - *Alan F. Beardon*
- [ ] **GTM 241** - The Arithmetic of Dynamical Systems - *Joseph H. Silverman*

---

## 16. 数值分析与优化 (Numerical Analysis and Optimization)

- [ ] **GTM 140** - Optima and Equilibria - *Jean-Pierre Aubin* (2nd ed.)
- [ ] **GTM 181** - Numerical Analysis - *Rainer Kress*
- [ ] **GTM 238** - Foundations of Optimization in Finite Dimensions - *Osman Guler*
- [ ] **GTM 260** - Calculus Without Derivatives - *Jean-Paul Penot*
- [ ] **GTM 262** - Integer Programming - *Michelangelo Conforti, Gérard P. Cornuéjols, Giacomo Zambelli*

---

## 17. p-adic分析 (p-adic Analysis)

- [ ] **GTM 58** - p-adic Numbers, p-adic Analysis, and Zeta-Functions - *Neal Koblitz* (2nd ed.)
- [ ] **GTM 114** - A Course in Number Theory and Cryptography - *Neal Koblitz* (2nd ed.)
- [ ] **GTM 198** - A Course in p-adic Analysis - *Alain M. Robert*

---

## 18. 交换代数与代数几何专题 (Commutative Algebra and Algebraic Geometry Topics)

- [ ] **GTM 78** - A Course in Universal Algebra - *Stanley Burris, H. P. Sankappanavar*
- [ ] **GTM 141** - Gröbner Bases - *Thomas Becker, Volker Weispfenning*
- [ ] **GTM 185** - Using Algebraic Geometry - *David A. Cox, John Little, Donal O'Shea* (2nd ed.)
- [ ] **GTM 259** - Monomial Ideals - *Jürgen Herzog, Hibi Takayuki*
- [ ] **GTM 280** - Binomial Ideals - *Jürgen Herzog, Takayuki Hibi, Hidefumi Ohsugi*

---

## 19. 其他专题 (Other Topics)

### 19.1 数学基础

- [ ] **GTM 123** - Numbers - *Heinz-Dieter Ebbinghaus et al.*
- [ ] **GTM 190** - Problems in Algebraic Number Theory - *M. Ram Murty, Jody Indigo Esmonde* (2nd ed.)
- [ ] **GTM 194** - Elementary Methods in Number Theory - *Melvyn B. Nathanson*
- [ ] **GTM 206** - Problems in Analytic Number Theory - *M. Ram Murty* (2nd ed.)
- [ ] **GTM 209** - Number Theory in Function Fields - *Michael Rosen*

### 19.2 非标准分析

- [ ] **GTM 188** - Lectures on the Hyperreals - *Robert Goldblatt*

### 19.3 凸分析

- [ ] **GTM 258** - Essentials of Integration Theory for Analysis - *Daniel W. Stroock*

### 19.4 四元数代数

- [ ] **GTM 288** - Quaternion Algebras - *John Voight*

### 19.5 辫子群

- [ ] **GTM 247** - Braid Groups - *Christian Kassel, Vladimir Turaev*
